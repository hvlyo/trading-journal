...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Dark theme color palette from the image
        dark: {
          bg: '#0f0f23',        // Main background
          card: '#1a1a2e',       // Card backgrounds
          sidebar: '#16213e',    // Sidebar background
          border: '#2d2d3d',     // Borders/dividers
          text: '#ffffff',       // Primary text
          textSecondary: '#a1a1aa', // Secondary text
          input: '#2a2a3a',      // Input field backgrounds
        },
        ...
        primary: {
          ...
          300: '#c4b5fd',
          400: '#a78bfa',
          500: '#8b5cf6',        // Main purple from image
          600: '#7c3aed',
          700: '#6d28d9',
          800: '#5b21b6',
          900: '#4c1d95',
      ...
      boxShadow: {
        ...
        'glow-dark': '0 0 20px rgba(139, 92, 246, 0.25)',
        'hover': '0 10px 25px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
        'hover-dark': '0 10px 25px -3px rgba(0, 0, 0, 0.4), 0 4px 6px -2px rgba(0, 0, 0, 0.3)',
      },
      animation: {
